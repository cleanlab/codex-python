...
class TestAccessKeys:
    ...
    @parametrize
    def test_method_revoke(self, client: CleanlabCodex) -> None:
    ...
    @parametrize
    def test_raw_response_revoke(self, client: CleanlabCodex) -> None:
    ...
    @parametrize
    def test_streaming_response_revoke(self, client: CleanlabCodex) -> None:
...
class TestAsyncAccessKeys:
    ...
    @parametrize
    async def test_method_revoke(self, async_client: AsyncCleanlabCodex) -> None:
    ...
    @parametrize
    async def test_raw_response_revoke(self, async_client: AsyncCleanlabCodex) -> None:
    ...
    @parametrize
    async def test_streaming_response_revoke(self, async_client: AsyncCleanlabCodex) -> None:
