...
class TestProjects:
    ...
    @parametrize
    def test_method_export(self, client: CleanlabCodex) -> None:
    ...
    @parametrize
    def test_raw_response_export(self, client: CleanlabCodex) -> None:
    ...
    @parametrize
    def test_streaming_response_export(self, client: CleanlabCodex) -> None:
...
class TestAsyncProjects:
    ...
    @parametrize
    async def test_method_export(self, async_client: AsyncCleanlabCodex) -> None:
    ...
    @parametrize
    async def test_raw_response_export(self, async_client: AsyncCleanlabCodex) -> None:
    ...
    @parametrize
    async def test_streaming_response_export(self, async_client: AsyncCleanlabCodex) -> None:
